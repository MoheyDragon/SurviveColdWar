...
public class Tutorial : MonoBehaviour
{
    ...
    private void UpdateTutorialText()
    {
        ...
        {
            tutorialTextFixer.fixedText = "";
            tutorialText.text = Texts[Level];
