...
public class Tutorial : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Level == 18 && OldGameManager.nameOfAction == "Research")
        {
            Next(false);
            OldGameManager.Info.transform.GetChild(21).GetComponent<Button>().interactable = true;
            OldGameManager.Info.transform.GetChild(20).GetComponent<Button>().interactable = false;
        }
        ...
        if (Level == 20 && !FactoryLock)
        {
            ...
            OldGameManager.Info.transform.GetChild(21).GetComponent<Button>().interactable = false;
